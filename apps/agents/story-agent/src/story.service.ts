// Generated by Kiro - Story generation service using OpenAI GPT-4
...
export class StoryService {
  ...
  private readonly model = 'gpt-3.5-turbo'; // Changed from gpt-4 for broader API key compatibility
  ...
  async generateStory(request: StoryGenerationRequest): Promise<StoryGenerationResponse> {
    ...
    const story = await this.executeWithRetry(async () => {
      ...
      if (!generatedStory) {
        throw new Error('Failed to generate story: No content returned from OpenAI');
      }
